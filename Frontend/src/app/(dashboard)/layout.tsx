      ...
      <div className="w-64 bg-white shadow-lg border-r border-gray-200 flex flex-col">
        ...
        <div className="p-4 border-b border-gray-200 bg-white relative">
          ...
          >
            ...
            <div className="h-10 w-10 rounded-full overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-center text-white font-semibold flex-shrink-0">
          ...
          {navigation.map((item) => {
            ...
            return (
              <Link
                key={item.href}
                href={item.href}
                className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium mb-1 transition-all ${isActive
